...
def main():
    ...
    model_len = len(test_data_loader) if test_data_loader else 0
    eval_len = len(test_data_loader) if test_data_loader else 0
    trainer.validate_qbnorm(model_len, eval_len)
