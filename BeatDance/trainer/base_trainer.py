...
class BaseTrainer:
    ...
    def validate(self, model_len, eval_len):
        self._valid_epoch_step(0,0,0, model_len, eval_len)

    def validate_qbnorm(self, model_len, eval_len):
        self._valid_qbnorm_epoch_step(0,0,0, model_len, eval_len)
