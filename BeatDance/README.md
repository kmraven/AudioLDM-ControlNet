...
```python
nohup python aist_05_train_L10.py --exp_name=BeatDance_L_110 --batch_size=32 --beta 0.4 --huggingface --dataset_name=aist --num_epochs 150 --num_frames 110 --dropout1 0.3 --dropout2 0.6 > ./result/train.log 2>&1
...
nohup python train.py --exp_name=BeatDance_L_110 --batch_size=32  --beta 0.4 --huggingface --dataset_name=aist --num_epochs 150 --num_frames 110 --dropout1 0.3 --dropout2 0.6 > ./result/train.log 2>&1 &

nohup python aist_05_train_L110.py --exp_name=BeatDance_L_128 --batch_size=32 --beta 0.4 --huggingface --dataset_name=aist --num_epochs 150 --num_frames 128 --dropout1 0.3 --dropout2 0.6 > ./result/train.log 2>&1

nohup python test.py --exp_name=MotionBERT_pos --batch_size=32  --beta 0.4 --load_epoch -1 --dataset_name=aist --num_frames 128 > ./result/m2v_test.log 2>&1 &
...
nohup python test.py --exp_name=seglen110_L110_batchsize32_framewise --batch_size=32  --beta 0.4 --load_epoch -1 --dataset_name=aist --metric v2t --num_frames 110 > ./result/v2m_test.log 2>&1 &
...
nohup python test_qb_norm.py --exp_name=seglen110_L110_batchsize32_framewise --beta 0.4 --load_epoch -1 --dataset_name=aist --num_frames 110 --qbnorm_k 1 --qbnorm_beta 20 --qbnorm_mode train > ./result/m2v_test_qbnorm.log 2>&1 &

nohup python test_qb_norm.py \
  --exp_name=MotionBERT_pos \
  --batch_size=32 \
  --beta 0.4 \
  --load_epoch -1 \
...
nohup python test_qb_norm.py --exp_name=seglen110_L110_batchsize32_framewise --beta 0.4 --load_epoch -1 --dataset_name=aist --num_frames 110 --qbnorm_k 1 --qbnorm_beta 20 --qbnorm_mode train --metric v2t > ./result/v2m_test_qbnorm.log 2>&1 &
