...
- AudioLDM related ckpt: follow the instruction in [original AudioLDM README](https://github.com/haoheliu/AudioLDM-training-finetuning?tab=readme-ov-file#download-checkpoints-and-dataset)
...
3. put the aist++ dataset that is provided by `Textual inversion repo` ([link](https://github.com/lsfhuihuiff/Dance-to-music_Siggraph_Asia_2024?tab=readme-ov-file#prepare-dataset)) into `data/dataset/aist`
